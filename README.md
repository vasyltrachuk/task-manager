...
## Telegram Webhook In Local Dev (Public HTTPS)
...
For early development before payment infrastructure is live:

- `SAAS_ENFORCE_SUBSCRIPTIONS=false`

When checkout/webhook infrastructure is ready for rollout:

- `SAAS_ENFORCE_SUBSCRIPTIONS=true`
- `BILLING_WEBHOOK_SECRET=<your-shared-secret>`
